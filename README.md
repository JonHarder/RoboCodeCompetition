...
All of the wave surfing code was taken almost verbatim from the robocode wiki
[here](http://robowiki.net/wiki/Wave_Surfing_Tutorial)

### Guess Factor Targeting
wiki [article](http://robowiki.net/wiki/Guess_Factor) on guess factor 
...
All of guess factor targeting in the bot was taken almost verbatim from the robocode wiki
[here](http://robowiki.net/wiki/GuessFactor_Targeting_Tutorial)
